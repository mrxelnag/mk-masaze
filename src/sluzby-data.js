// This file contains data for massage services
export const massageServices = [
  {
    ...
    longDescription: `
      ...
      Během této masáže se zaměřujeme na problematické oblasti, kde se hromadí napětí.

      Masáž začíná jemnými tahy, které postupně přecházejí do hlubších technik.
      Používáme kvalitní oleje, které vyživují pokožku a zároveň usnadňují masážní pohyby.
  ...
  },
  {
    ...
    longDescription: `
      ...
      Tato masáž je vhodná pro ty, kteří trpí chronickými bolestmi nebo mají specifické svalové problémy.

      Během masáže používáme techniky hlubokého tlaku a cílené manipulace, které pomáhají uvolnit
      zatuhlé svaly a fascie. Masáž může být místy intenzivnější, ale výsledkem je výrazná úleva.
